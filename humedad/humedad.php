...
$hora_temperatura = file_get_contents("../Api/files/Humedad/Hora.txt");
$data_temperatura = file_get_contents("../Api/files/Humedad/data.txt");
           ...
           <div class="main--content">
             <div class="header--wrapper">
                <div class="header--title">
                   <div class="menu-item" >
                      <h2 style="display: inline-block; padding-right: 688px; color: #FDFEFE ;" >Humedad</h2>
                      <div class="col-sm">
        ...
        <div class="card text-center" style="border-radius: 24px;">
            <div class="card-body">
                ...
                <script>
                    ...
                    const yValues = [<?php
                        $valid_Humidity = array_filter(explode(PHP_EOL, $valor_Humeda), function($value) {
                            return !empty($value);
                        });
                        echo implode(",", $valid_Humidity);
                    ?>];
...
<div class="row justify-content-center">
    <div class="col-sm">
        <div class="card text-center" style="border-radius: 24px;">
            <div class="card-body">
                <h5 class="card-title" style="text-align: left;">Historico Humedad</h5>
                <table class="table">
                    <thead>
                        <tr>
