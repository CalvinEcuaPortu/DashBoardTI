...
<div class="row justify-content-center">
    <div class="col-sm">
        <div class="card text-center" style="border-radius: 24px;">
            <div class="card-body">
                <h5 class="card-title" style="text-align: left;">Historico de Aparcamentos (P)</h5>
                <canvas id="myChart"></canvas>
                <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
                <script>
                    // Obtener los valores de temperatura válidos para el gráfico
                    const yValues = [<?php
                        $valid_Aparcamento = array_filter(explode(PHP_EOL, $valor_Aparcamento), function($value) {
                            return !empty($value);
                        });
                        echo implode(",", $valid_Aparcamento);
                    ?>];
            ...
            <div class="card-body">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        $valores = explode(PHP_EOL, $valor_Aparcamento);
