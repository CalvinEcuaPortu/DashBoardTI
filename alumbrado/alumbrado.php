...
<div class="row">
  <div class="col-sm-4">
    <div class="card text-center mb-3" style="width: 18rem; border-radius: 24px;">
      <div class="card-body">
        <img class="zone-image" style="width: 10rem; border-radius: 24px;" src="../imagenes/street_off.jpg" alt="poste1">
  ...
  <div class="col-sm-4">
    <div class="card text-center mb-3" style="width: 18rem; border-radius: 24px;">
      <div class="card-body">
        <img class="zone-image" style="width: 10rem; border-radius: 24px;" src="../imagenes/street_off.jpg" alt="poste2">
        <h5 class="card-title">Alumbrado Publico</h5>
  ...
  <div class="col-sm-4">
    <div class="card text-center mb-3" style="width: 18rem; border-radius: 24px;">
      <div class="card-body">
        <img class="zone-image" style="width: 10rem; border-radius: 24px;" src="../imagenes/street_off.jpg" alt="poste3">
        <h5 class="card-title">Alumbrado Publico</h5>
