...
<div id="table1" style="display: none;">
    ...
    foreach ($valores as $key => $valor) {
        ...
        if (!empty($valor)) {
            echo "<tr>";
            echo "<td>";
            // Usar el contador del checkbox para generar un ID único
            echo "<input class='form-check-input me-1' type='checkbox' value='' id='humidityCheckbox" . $checkbox_id . "'>";
            echo "</td>";
...
<div id="table2" style="display: none;">
    ...
    foreach ($valores as $key => $valor) {
        ...
        if (!empty($valor)) {
            ...
            echo "<td>";
            // Usar el contador del checkbox para generar un ID único
            echo "<input class='form-check-input me-1' type='checkbox' value='' id='temperatureCheckbox" . $checkbox_id . "'>";
            echo "</td>";
            // Verificar si el índice actual existe en el array de horas antes de mostrarlo
            $hora = isset($horas[$key]) ? $horas[$key] : '';
            $fecha = isset($fechas[$key]) ? $fechas[$key] : '';
...
<div id="table3" style="display: none;">
    ...
    foreach ($valores as $key => $valor) {
        ...
        if (!empty($valor)) {
            ...
            echo "<td>";
            // Usar el contador del checkbox para generar un ID único
            echo "<input class='form-check-input me-1' type='checkbox' value='' id='lightingCheckbox" . $checkbox_id . "'>";
            echo "</td>";
            // Verificar si el índice actual existe en el array de horas antes de mostrarlo
            $hora = isset($horas[$key]) ? $horas[$key] : '';
            $fecha = isset($fechas[$key]) ? $fechas[$key] : '';
...
<div id="table4" style="display: none;">
    ...
    // Contador para el id del checkbox
    $checkbox_id = 1;
    // Iterar sobre cada valor de aparcamento y mostrarlo en una fila de la tabla
    foreach ($valores as $key => $valor) {
        // Verificar si el valor de aparcamento es válido
        if (!empty($valor)) {
            echo "<tr>";
            echo "<td>";
            // Usar el contador del checkbox para generar un ID único
            echo "<input class='form-check-input me-1' type='checkbox' value='' id='parkingCheckbox" . $checkbox_id . "'>";
            echo "</td>";
            // Verificar si el índice actual existe en el array de horas antes de mostrarlo
            $hora = isset($horas[$key]) ? $horas[$key] : '';
            $fecha = isset($fechas[$key]) ? $fechas[$key] : '';
            echo "<td>$historico[$key]</td>"; // Mostrar el tipo de aparcamento correspondiente
            echo "<td>$valor P</td>";
            echo "<td>$fecha</td>";
            echo "<td>$hora</td>";
            echo "</tr>";
